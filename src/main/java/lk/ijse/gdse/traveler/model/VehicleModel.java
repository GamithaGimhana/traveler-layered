...
public class VehicleModel {
    ...
    public ArrayList<String> getAllVehicleTypes() throws SQLException {
        ResultSet rst = CrudUtil.execute("select vehicle_type from vehicle");
    ...
    public ArrayList<String> getAllVehicleModels(String selectedVehicleType) throws SQLException {
        ResultSet rst = CrudUtil.execute("select model from vehicle where vehicle_type = ?", selectedVehicleType);
